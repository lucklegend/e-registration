...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<?php echo Form::open(array('name' => 'search_form', 'url' => URL::to('events'), 'class'=>'form-inline', 'role' => 'form')); ?>
	...
	<div class="table-responsive">
		...
		<tbody>
		    ...
		    <?php $i++; ?>
		    <?php echo $__env->make('events.index_row', ['row' => $row, 'i' => $i], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		    <?php endforeach; ?>
		</tbody>
		</table>
	</div>

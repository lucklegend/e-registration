			...
			<div class="row text-left">
				...
				<div class="row">
					...
					<div class="form-group col-sm-6">
						...
						<?php echo Form::select('vis_province', array_merge([''=>'Please Select'],$province), NULL, ['class'=>'form-control input-sm']); ?>
				...
				<div class="row">
					<div class="form-group col-sm-6">
						<?php echo Form::label('vis_municipality', 'Municipality', array('class' => 'control-label')); ?>

						<?php echo Form::select('vis_municipality', array_merge([''=>'Please Select'],$municipality), NULL, ['class'=>'form-control input-sm']); ?>

...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<div class="clearfix">
			...
			<div class="pull-right">
				<a class="btn btn-success btn-xs" href="<?php echo e(URL::to('/users/add')); ?>" title="Add Item" role="button"><span class="fa fa-plus"></span> Add Item</a>
				<?php if(App\Http\Controllers\LoginController::can_access('Users', 'add')): ?>
	        	<?php endif; ?>
			</div>
		</div>
	</div>
	<div class="panel-body">
		...
		?>
		<?php echo Form::open(array('name' => 'search_form', 'url' => URL::to('users'), 'class'=>'form-inline', 'role' => 'form')); ?>

			<div class="form-group">
				<div class="input-group input-group-sm">
					<span class="input-group-addon">Group</span>
					<?php echo Form::select('qt', $groups, $qt, ['class'=>'form-control input-sm']); ?>
	...
	<div class="table-responsive">
		...
		<tbody>
		    ...
		    <?php $i++; ?>
		    <?php echo $__env->make('users.index_row', ['row' => $row, 'i' => $i], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		    <?php endforeach; ?>
		</tbody>
		</table>
	</div>
